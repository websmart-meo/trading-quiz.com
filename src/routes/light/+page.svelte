<script lang="ts">
	import Screen1 from '../../components/light/Screen1.svelte';
	import Screen2 from '../../components/light/Screen2.svelte';
	import Screen3 from '../../components/light/Screen3.svelte';
